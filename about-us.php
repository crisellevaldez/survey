    ...
    <div class="px-4 py-5 my-5 text-center">
      ...
      <div class="col-lg-8 mx-auto">
        <p class="lead mb-4">Our goal as a team is to gather
          ...
          State University CICT Students
          using this website that contains
          surveys and questionnaires. We
          as the researchers are delighted
          to express findings and results
          that would benefit each
          individuals on our study. To
          provide insights and enlighten
          everyone regarding about stress,
          the levels of it and how to
          mitigate it</p>
      </div>
    </div>
  </div>
